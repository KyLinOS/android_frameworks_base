...
public class DateUtils
{
    ...
    private static final int []sAmPmCN=new int[]{
    	com.kylin.internal.R.string.lc,
        com.kylin.internal.R.string.lm,
        com.kylin.internal.R.string.zc,
        com.kylin.internal.R.string.sw,
        com.kylin.internal.R.string.zw,
        com.kylin.internal.R.string.xw,
        com.kylin.internal.R.string.bw,
        com.kylin.internal.R.string.sy
    };
