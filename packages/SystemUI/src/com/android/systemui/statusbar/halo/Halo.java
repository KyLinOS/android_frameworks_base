...
public class Halo extends FrameLayout implements Ticker.TickerCallback {
    ...
    void tick(NotificationData.Entry entry, int delay, int duration, boolean alwaysFlip, boolean showContent, boolean flipContent) {
        ...
        if (entry.notification.getPackageName().equals("com.kylin.halo")) {
    ...
    public int getHidden() {
        ...
        for (int i = 0; i < mNotificationData.size(); i++ ) {
            ...
            boolean hide = (statusNotify.getPackageName().equals("com.kylin.halo") || (allowed && persistent));
            if (hide) ignore++;
        }
        return ignore;
    }
    ...
    public class ScreenReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if(intent.getAction().equals(Intent.ACTION_USER_PRESENT) &&
                    ...
                    Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.HALO_UNLOCK_PING, 0, UserHandle.USER_CURRENT) == 1 &&
